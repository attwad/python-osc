...
class TestOscTcpServer(unittest.TestCase):
    pass
...
class TestTCP_1_1_Handler(unittest.TestCase):
    ...
    def test_no_match(self):
        ...
        mock_sock.recv.side_effect = [_SIMPLE_MSG_NO_PARAMS_1_1, _SIMPLE_PARAM_INT_MSG_1_1, ""]
    ...
    def test_match_with_args(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [_SIMPLE_PARAM_INT_MSG_1_1, ""]
        osc_tcp_server._TCPHandler1_1(
            mock_sock, self.client_address, self.server)
    ...
    def test_match_int9(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [_SIMPLE_PARAM_INT_9_1_1, ""]
        osc_tcp_server._TCPHandler1_1(
            mock_sock, self.client_address, self.server)
    ...
    def test_response_with_args(self):
        ...
        osc_tcp_server._TCPHandler1_1(
            mock_sock, self.client_address, self.server)
        mock_sock.sendall.assert_called_with(b'\xc0/SYNC\00\00\00,isf\x00\x00\x00\x00\x00\x00\x00\x012\x00\x00\x00@@\x00\x00\xc0')
...
class TestTCP_1_0_Handler(unittest.TestCase):
    ...
    def test_no_match(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [LEN_SIMPLE_MSG_NO_PARAMS, _SIMPLE_MSG_NO_PARAMS, LEN_SIMPLE_PARAM_INT_MSG,
                                      _SIMPLE_PARAM_INT_MSG, ""]
    ...
    def test_match_with_args(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [LEN_SIMPLE_PARAM_INT_MSG, _SIMPLE_PARAM_INT_MSG, ""]
        osc_tcp_server._TCPHandler1_0(
            mock_sock, self.client_address, self.server)
        self.mock_meth.assert_called_with("/SYNC", [1, 2, 3], 4)
    ...
    def test_match_int9(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [LEN_SIMPLE_PARAM_INT_9, _SIMPLE_PARAM_INT_9, ""]
        osc_tcp_server._TCPHandler1_0(
            mock_sock, self.client_address, self.server)
        self.assertTrue(self.mock_meth.called)
        self.mock_meth.assert_called_with("/debug", 9)
    ...
    def test_match_without_args(self):
        ...
        mock_sock = mock.Mock()
        mock_sock.recv = mock.Mock()
        mock_sock.recv.side_effect = [LEN_SIMPLE_MSG_NO_PARAMS, _SIMPLE_MSG_NO_PARAMS, ""]
        osc_tcp_server._TCPHandler1_0(
            mock_sock, self.client_address, self.server)
        self.mock_meth.assert_called_with("/SYNC")
    ...
    def test_response_with_args(self):
        ...
        osc_tcp_server._TCPHandler1_0(
            mock_sock, self.client_address, self.server)
        mock_sock.sendall.assert_called_with(b'\x00\x00\x00\x1c/SYNC\00\00\00,isf\x00\x00\x00\x00\x00\x00\x00\x012\x00\x00\x00@@\x00\x00')
...
class TestAsync1_1Handler(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_no_match(self):
        self.dispatcher.map("/foobar", self.mock_meth)
        self.mock_reader.read.side_effect = [_SIMPLE_MSG_NO_PARAMS_1_1, _SIMPLE_PARAM_INT_MSG_1_1, b'']
    ...
    async def test_response_with_args(self):
        ...
        self.mock_reader.read.side_effect = [_SIMPLE_MSG_NO_PARAMS_1_1, b'']
        await osc_tcp_server.AsyncOSCTCPServer.handle(self.server, self.mock_reader, self.mock_writer)
        self.mock_writer.write.assert_called_with(b'\xc0/SYNC\00\00\00,isf\x00\x00\x00\x00\x00\x00\x00\x012\x00\x00\x00@@\x00\x00\xc0')
